...
| MAILBOX AXI USER programming rules | The value of CPTRA\_MBOX\_VALID\_AXI\_USER\[4:0\] register must be programmed by SoC. After it is locked, the value in this register becomes a valid AXI USER for accessing the mailbox.                                                                                              | Security                 | Required for Caliptra threat model                |
