...
| Resets and Clocks                | SoC shall ensure Caliptra's powergood (*cptra_pwrgood*) is tied to SoC’s own powergood or any other reset that triggers SoC’s cold boot flow.                                                                                                                                                    | Statement of conformance | Required for Caliptra threat model                |
| Resets and Clocks                | SoC shall ensure Caliptra's reset (*cptra_rst_b*) is tied to SoC’s own reset such that Caliptra cannot be reset without also resetting the SoC.                                                                                                                               | Statement of conformance | Required for Caliptra threat model                |
