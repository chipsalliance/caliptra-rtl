...
| Fuses                            | SoC shall burn non-field fuses during manufacturing. All fuses listed in the [fuse map](https://github.com/chipsalliance/Caliptra/blob/main/doc/Caliptra.md#fuse-map) are mandatory. Subsystem fuses used outside of the subsystem context and vendor/SoC fuses are optional.                                                           | Test on silicon          | Required for UDS threat model                     |
