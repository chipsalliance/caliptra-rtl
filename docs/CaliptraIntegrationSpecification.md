...
| :--------- | :--------- | :--------- | :--------- |
| General                  | All Caliptra RTL, ROM, and FMC/Runtime code shall be integrated from a currently supported release branch except where explicitly excepted.                                                                          | Statement of conformance | Unapproved modifications to these components risk the introduction of security vulnerabilities    |
