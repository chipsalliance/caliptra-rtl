...
In caliptra-rtl releases, the `build_identifier` is always an alphanumeric key that begins with a 0-indexed numeric value. The full format of the build identifier is: `<incrementing_numeric_value>.<alphanumeric_descriptor>`
