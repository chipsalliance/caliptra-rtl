...
Generated files under `rtl/generated/` and `dv/generated/` are produced by `tools/scripts/reg_gen.sh` from the RDL sources in `rdl/`; do not edit them by hand.
```
src/<block>
...
|-- rdl                 # SystemRDL sources ({block}_reg.rdl, shared *_def.rdl) — inputs to reg_gen
...
|   `-- generated       #   Generated UVM RAL model: {rdl_stem}_uvm.sv (from reg_gen.sh)
...
* Register documentation is auto-rendered at the GitHub page
  * [main internal registers](https://chipsalliance.github.io/caliptra-rtl/main/internal-regs)
  * [main external registers](https://chipsalliance.github.io/caliptra-rtl/main/external-regs)
