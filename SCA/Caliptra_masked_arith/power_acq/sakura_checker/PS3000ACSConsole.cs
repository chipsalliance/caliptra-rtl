...
namespace SAKURA
{
	...
	class PS3000ACSConsole
	{
		...
		public const int BUFFER_SIZE = 1750;
		...
		****************************************************************************/
...

		{
			...
			if (ready > 0)
			{
				...
				string tvla_name = "C:/Users/t-ekarabulut/OneDrive - Microsoft/Caliptra_masked_arith/data/tvla.csv";
				...
				if (curr_trace == 0)
					string1 = "C:/Users/t-ekarabulut/OneDrive - Microsoft/Caliptra_masked_arith/data/powertrace_fixed_";
				else
					string1 = "C:/Users/t-ekarabulut/OneDrive - Microsoft/Caliptra_masked_arith/data/powertrace_rnd_";
