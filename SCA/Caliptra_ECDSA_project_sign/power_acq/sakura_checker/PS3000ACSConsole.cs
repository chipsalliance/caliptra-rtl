...
namespace SAKURA
{
	...
	class PS3000ACSConsole
	{
		...
		public const int BUFFER_SIZE = 750;
		...
		****************************************************************************/
...

		{
			...
			if (ready > 0)
			{
				...
				string tvla_name = "C:/Users/t-ekarabulut/OneDrive - Microsoft/Caliptra_ECDSA_project_sign/data/tvla.csv";
				...
				if (curr_trace == 0)
					string1 = "C:/Users/t-ekarabulut/OneDrive - Microsoft/Caliptra_ECDSA_project_sign/data/powertrace_fixed_";
				else
					string1 = "C:/Users/t-ekarabulut/OneDrive - Microsoft/Caliptra_ECDSA_project_sign/data/powertrace_rnd_";
					...
					for (int i = 0; i < sampleCount; i++)
					{
						...
						for (int ch = 0; ch < 1; ch++)
						{
							if (_channelSettings[ch].enabled)
							{
								...
								//writer.Write("," + maxPinned[ch].Target[i]);
								//writer.Write(minPinned[ch].Target[i] + ",");
