...
package mbox_csr_uvm;
    ...
    class mbox_csr__mbox_status_ecc_double_error_38cec4b0_ecc_single_error_9c62b760 extends uvm_reg;
        ...
        mbox_csr__mbox_status_ecc_double_error_38cec4b0_ecc_single_error_9c62b760_bit_cg tap_has_lock_bit_cg[1];
        ...
        rand uvm_reg_field tap_has_lock;
        ...
        virtual function void build();
            ...
            this.tap_has_lock = new("tap_has_lock");
            this.tap_has_lock.configure(this, 1, 26, "RO", 1, 'h0, 1, 1, 0);
            if (has_coverage(UVM_CVR_REG_BITS)) begin
                ...
                foreach(tap_has_lock_bit_cg[bt]) tap_has_lock_bit_cg[bt] = new();
            end
            if (has_coverage(UVM_CVR_FIELD_VALS))
                fld_cg = new();
        endfunction : build
