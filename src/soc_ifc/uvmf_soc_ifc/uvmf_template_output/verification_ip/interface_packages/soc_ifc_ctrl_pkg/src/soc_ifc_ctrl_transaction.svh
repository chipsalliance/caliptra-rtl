...
class soc_ifc_ctrl_transaction  extends uvmf_transaction_base;
  ...
  constraint debug_locked_c {security_state.debug_locked == MuBi4True;} // MuBi4True: debug locked
  ...
  constraint set_bootfsm_breakpoint_c { if ((security_state.debug_locked == MuBi4True) & 
                                            ~((security_state.debug_locked == MuBi4True) & (security_state.device_lifecycle == DEVICE_MANUFACTURING)))
