...
class soc_ifc_env_reset_sequence_base extends soc_ifc_env_sequence_base #(.CONFIG_T(soc_ifc_env_configuration_t));
  ...
  virtual task configure_breakpoint(input ctrl_reset_seq_context_t ctrl_rst_ctx);
    ...
    if (ctrl_rst_ctx.set_bootfsm_breakpoint && ((ctrl_rst_ctx.security_state.debug_locked == 4'h9) || (ctrl_rst_ctx.security_state.debug_locked != 4'h9 && ctrl_rst_ctx.security_state.device_lifecycle == DEVICE_MANUFACTURING))) begin
