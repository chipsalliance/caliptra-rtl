...
`define GENERIC_AND_FUSE_REG_CPTRA_HW_ERROR_FATAL_RV_DCLS_ERR_LOW                                   (6)
`define GENERIC_AND_FUSE_REG_CPTRA_HW_ERROR_FATAL_RV_DCLS_ERR_MASK                                  (32'h3c0)
`define GENERIC_AND_FUSE_REG_CPTRA_HW_ERROR_FATAL_RSVD_LOW                                          (10)
`define GENERIC_AND_FUSE_REG_CPTRA_HW_ERROR_FATAL_RSVD_MASK                                         (32'hfffffc00)
`endif
