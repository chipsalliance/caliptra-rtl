...
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_0                                      (0x30030118)
#define GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_0                                                       (0x118)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_1                                      (0x3003011c)
#define GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_1                                                       (0x11c)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_2                                      (0x30030120)
#define GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_2                                                       (0x120)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_3                                      (0x30030124)
#define GENERIC_AND_FUSE_REG_CPTRA_RSVD_REG_3                                                       (0x124)
