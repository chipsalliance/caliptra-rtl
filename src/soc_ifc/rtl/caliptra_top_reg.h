...
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_0                       (0x305e0)
#ifndef GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_0
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_0                                        (0x5e0)
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_1                       (0x305e4)
#ifndef GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_1
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_1                                        (0x5e4)
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK                    (0x305e8)
#ifndef GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK                                     (0x5e8)
