...
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_L                    (0x305e0)
#ifndef GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_L
#define GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_L                                     (0x5e0)
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_H                    (0x305e4)
#ifndef GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_H
#define GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_H                                     (0x5e4)
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_LOCK                 (0x305e8)
#ifndef GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_LOCK
#define GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_LOCK                                  (0x5e8)
#define GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_LOCK_LOCK_LOW                         (0)
#define GENERIC_AND_FUSE_REG_SS_EXTERNAL_STAGING_AREA_ADDRESS_LOCK_LOCK_MASK                        (0x1)
#endif
