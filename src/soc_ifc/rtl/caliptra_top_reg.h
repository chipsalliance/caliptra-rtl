...
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_DEBUG_AUTH_PK_HASH_REG_BANK_OFFSET              (0x30030174)
#define GENERIC_AND_FUSE_REG_CPTRA_DEBUG_AUTH_PK_HASH_REG_BANK_OFFSET                               (0x174)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_NUM_OF_DEBUG_AUTH_PK_HASHES                     (0x30030178)
#define GENERIC_AND_FUSE_REG_CPTRA_NUM_OF_DEBUG_AUTH_PK_HASHES                                      (0x178)
...
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_0                          (0x3003035c)
#define GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_0                                           (0x35c)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_1                          (0x30030360)
#define GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_1                                           (0x360)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_2                          (0x30030364)
#define GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_2                                           (0x364)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_3                          (0x30030368)
#define GENERIC_AND_FUSE_REG_FUSE_PROD_DBG_UNLOCK_TOKEN_3                                           (0x368)
