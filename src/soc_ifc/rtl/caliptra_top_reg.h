...
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_0                       (0x30174)
#ifndef GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_0
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_0                                        (0x174)
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_1                       (0x30178)
#ifndef GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_1
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_1                                        (0x178)
#endif
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK                    (0x3017c)
#ifndef GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK                                     (0x17c)
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK_LOCK_LOW                            (0)
#define GENERIC_AND_FUSE_REG_EXTERNAL_STAGING_AREA_ADDRESS_LOCK_LOCK_MASK                           (0x1)
#endif
