...
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_FUSE_VALID_PAUSER                               (0x30030104)
#define GENERIC_AND_FUSE_REG_CPTRA_FUSE_VALID_PAUSER                                                (0x104)
#define CALIPTRA_TOP_REG_GENERIC_AND_FUSE_REG_CPTRA_FUSE_PAUSER_LOCK                                (0x30030108)
#define GENERIC_AND_FUSE_REG_CPTRA_FUSE_PAUSER_LOCK                                                 (0x108)
