...
//         generates a random number with 256-bit.
//         the parameter is :
//            - [SHA-256]
...
//                  to generate a 256-bit random value while it's in (0, prime) range.
...
#(
  ...
  parameter                  LFSR_LENGTH     = LFSR_SEED_SIZE,
  parameter [REG_SIZE-1 : 0] HMAC_DRBG_PRIME = 256'hFFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551
)
(
  // Clock and reset.
  input wire                        clk,
  ...
  //----------------------------------------------------------------
  // Register/Wires for HMAC-256 module instantiation.
  //----------------------------------------------------------------
  reg                    HMAC_init;
  reg                    HMAC_next;
  reg                    HMAC_last;
