...
class HMAC256_scoreboard #(
 ...
 extends BASE_T;
  ...
  `uvm_component_param_utils( HMAC256_scoreboard #(
                              CONFIG_T,
                              BASE_T
                              )
)
  ...
  uvm_analysis_imp_actual_ahb_analysis_export #(mvc_sequence_item_base, HMAC256_scoreboard #(
                              .CONFIG_T(CONFIG_T),
                              .BASE_T(BASE_T)
                              )
) actual_ahb_analysis_export;
  ...
  uvm_analysis_imp_expected_ahb_analysis_export #(mvc_sequence_item_base, HMAC256_scoreboard #(
                              .CONFIG_T(CONFIG_T),
                              .BASE_T(BASE_T)
                              )
