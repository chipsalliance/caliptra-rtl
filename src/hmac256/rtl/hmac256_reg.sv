...
module hmac256_reg (
        ...
        input hmac256_reg_pkg::hmac256_reg__in_t hwif_in,
        output hmac256_reg_pkg::hmac256_reg__out_t hwif_out
    );
    ...
    always_comb begin
        for(int i0=0; i0<2; i0++) begin
            decoded_reg_strb.HMAC256_NAME[i0] = cpuif_req_masked & (cpuif_addr == 12'h0 + i0*12'h4);
        end
        for(int i0=0; i0<2; i0++) begin
            decoded_reg_strb.HMAC256_VERSION[i0] = cpuif_req_masked & (cpuif_addr == 12'h8 + i0*12'h4);
        end
        ...
        for(int i0=0; i0<16; i0++) begin
            decoded_reg_strb.HMAC256_BLOCK[i0] = cpuif_req_masked & (cpuif_addr == 12'h80 + i0*12'h4);
        end
    ...
    // Field: hmac256_reg.HMAC256_CTRL.INIT
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.HMAC256_CTRL.INIT.value;
        load_next_c = '0;
        if(decoded_reg_strb.HMAC256_CTRL && decoded_req_is_wr && hwif_in.HMAC256_CTRL.INIT.swwe) begin // SW write
            next_c = (field_storage.HMAC256_CTRL.INIT.value & ~decoded_wr_biten[0:0]) | (decoded_wr_data[0:0] & decoded_wr_biten[0:0]);
            load_next_c = '1;
        end else begin // singlepulse clears back to 0
            next_c = '0;
            load_next_c = '1;
        end
        field_combo.HMAC256_CTRL.INIT.next = next_c;
        field_combo.HMAC256_CTRL.INIT.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.HMAC256_CTRL.INIT.value <= 1'h0;
        end else if(field_combo.HMAC256_CTRL.INIT.load_next) begin
            field_storage.HMAC256_CTRL.INIT.value <= field_combo.HMAC256_CTRL.INIT.next;
        end
    end
    assign hwif_out.HMAC256_CTRL.INIT.value = field_storage.HMAC256_CTRL.INIT.value;
    // Field: hmac256_reg.HMAC256_CTRL.NEXT
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.HMAC256_CTRL.NEXT.value;
        load_next_c = '0;
        if(decoded_reg_strb.HMAC256_CTRL && decoded_req_is_wr && hwif_in.HMAC256_CTRL.NEXT.swwe) begin // SW write
            next_c = (field_storage.HMAC256_CTRL.NEXT.value & ~decoded_wr_biten[1:1]) | (decoded_wr_data[1:1] & decoded_wr_biten[1:1]);
            load_next_c = '1;
        end else begin // singlepulse clears back to 0
            next_c = '0;
            load_next_c = '1;
        end
        field_combo.HMAC256_CTRL.NEXT.next = next_c;
        field_combo.HMAC256_CTRL.NEXT.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.HMAC256_CTRL.NEXT.value <= 1'h0;
        end else if(field_combo.HMAC256_CTRL.NEXT.load_next) begin
            field_storage.HMAC256_CTRL.NEXT.value <= field_combo.HMAC256_CTRL.NEXT.next;
        end
    end
    assign hwif_out.HMAC256_CTRL.NEXT.value = field_storage.HMAC256_CTRL.NEXT.value;
    // Field: hmac256_reg.HMAC256_CTRL.ZEROIZE
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.HMAC256_CTRL.ZEROIZE.value;
        load_next_c = '0;
        if(decoded_reg_strb.HMAC256_CTRL && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.HMAC256_CTRL.ZEROIZE.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
            load_next_c = '1;
        end else begin // singlepulse clears back to 0
            next_c = '0;
            load_next_c = '1;
        end
        field_combo.HMAC256_CTRL.ZEROIZE.next = next_c;
        field_combo.HMAC256_CTRL.ZEROIZE.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.HMAC256_CTRL.ZEROIZE.value <= 1'h0;
        end else if(field_combo.HMAC256_CTRL.ZEROIZE.load_next) begin
            field_storage.HMAC256_CTRL.ZEROIZE.value <= field_combo.HMAC256_CTRL.ZEROIZE.next;
        end
    end
    assign hwif_out.HMAC256_CTRL.ZEROIZE.value = field_storage.HMAC256_CTRL.ZEROIZE.value;
    // Field: hmac256_reg.HMAC256_CTRL.MODE
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
        next_c = field_storage.HMAC256_CTRL.MODE.value;
        load_next_c = '0;
        if(decoded_reg_strb.HMAC256_CTRL && decoded_req_is_wr && hwif_in.HMAC256_CTRL.MODE.swwe) begin // SW write
            next_c = (field_storage.HMAC256_CTRL.MODE.value & ~decoded_wr_biten[3:3]) | (decoded_wr_data[3:3] & decoded_wr_biten[3:3]);
            load_next_c = '1;
        end
        field_combo.HMAC256_CTRL.MODE.next = next_c;
        field_combo.HMAC256_CTRL.MODE.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.HMAC256_CTRL.MODE.value <= 1'h1;
        end else if(field_combo.HMAC256_CTRL.MODE.load_next) begin
            field_storage.HMAC256_CTRL.MODE.value <= field_combo.HMAC256_CTRL.MODE.next;
        end
    end
    ...
    always_comb begin
        ...
        field_combo.HMAC256_CTRL.LAST.next = next_c;
        field_combo.HMAC256_CTRL.LAST.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.HMAC256_CTRL.LAST.value <= 1'h0;
        end else if(field_combo.HMAC256_CTRL.LAST.load_next) begin
            field_storage.HMAC256_CTRL.LAST.value <= field_combo.HMAC256_CTRL.LAST.next;
        end
    end
    ...
    always_comb begin
        ...
        field_combo.HMAC256_CTRL.RESTORE.next = next_c;
        field_combo.HMAC256_CTRL.RESTORE.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.HMAC256_CTRL.RESTORE.value <= 1'h0;
        end else if(field_combo.HMAC256_CTRL.RESTORE.load_next) begin
            field_storage.HMAC256_CTRL.RESTORE.value <= field_combo.HMAC256_CTRL.RESTORE.next;
        end
    end
    ...
    for(genvar i0=0; i0<16; i0++) begin
        ...
        always_comb begin
            ...
            automatic logic load_next_c;
            next_c = field_storage.HMAC256_KEY[i0].KEY.value;
            load_next_c = '0;
            ...
            field_combo.HMAC256_KEY[i0].KEY.next = next_c;
            field_combo.HMAC256_KEY[i0].KEY.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.HMAC256_KEY[i0].KEY.value <= 32'h0;
            end else if(field_combo.HMAC256_KEY[i0].KEY.load_next) begin
                field_storage.HMAC256_KEY[i0].KEY.value <= field_combo.HMAC256_KEY[i0].KEY.next;
            end
        end
        assign hwif_out.HMAC256_KEY[i0].KEY.value = field_storage.HMAC256_KEY[i0].KEY.value;
    end
    for(genvar i0=0; i0<16; i0++) begin
        // Field: hmac256_reg.HMAC256_BLOCK[].BLOCK
        always_comb begin
            automatic logic [31:0] next_c;
            automatic logic load_next_c;
            next_c = field_storage.HMAC256_BLOCK[i0].BLOCK.value;
            load_next_c = '0;
            ...
            field_combo.HMAC256_BLOCK[i0].BLOCK.next = next_c;
            field_combo.HMAC256_BLOCK[i0].BLOCK.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.HMAC256_BLOCK[i0].BLOCK.value <= 32'h0;
            end else if(field_combo.HMAC256_BLOCK[i0].BLOCK.load_next) begin
                field_storage.HMAC256_BLOCK[i0].BLOCK.value <= field_combo.HMAC256_BLOCK[i0].BLOCK.next;
            end
        end
        assign hwif_out.HMAC256_BLOCK[i0].BLOCK.value = field_storage.HMAC256_BLOCK[i0].BLOCK.value;
    end
    for(genvar i0=0; i0<8; i0++) begin
        // Field: hmac256_reg.HMAC256_TAG[].TAG
        always_comb begin
            automatic logic [31:0] next_c;
            automatic logic load_next_c;
            next_c = field_storage.HMAC256_TAG[i0].TAG.value;
            load_next_c = '0;
            if(decoded_reg_strb.HMAC256_TAG[i0] && decoded_req_is_wr) begin // SW write
                next_c = (field_storage.HMAC256_TAG[i0].TAG.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.HMAC256_TAG[i0].TAG.we) begin // HW Write - we
                next_c = hwif_in.HMAC256_TAG[i0].TAG.next;
                load_next_c = '1;
            end else if(hwif_in.HMAC256_TAG[i0].TAG.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.HMAC256_TAG[i0].TAG.next = next_c;
            field_combo.HMAC256_TAG[i0].TAG.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.HMAC256_TAG[i0].TAG.value <= 32'h0;
            end else if(field_combo.HMAC256_TAG[i0].TAG.load_next) begin
                field_storage.HMAC256_TAG[i0].TAG.value <= field_combo.HMAC256_TAG[i0].TAG.next;
            end
        end
    ...
    for(genvar i0=0; i0<3; i0++) begin
        ...
        always_comb begin
            automatic logic [31:0] next_c;
            automatic logic load_next_c;
            next_c = field_storage.HMAC256_LFSR_SEED[i0].LFSR_SEED.value;
            load_next_c = '0;
            if(decoded_reg_strb.HMAC256_LFSR_SEED[i0] && decoded_req_is_wr) begin // SW write
                next_c = (field_storage.HMAC256_LFSR_SEED[i0].LFSR_SEED.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end
            field_combo.HMAC256_LFSR_SEED[i0].LFSR_SEED.next = next_c;
            field_combo.HMAC256_LFSR_SEED[i0].LFSR_SEED.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.HMAC256_LFSR_SEED[i0].LFSR_SEED.value <= 32'h0;
            end else if(field_combo.HMAC256_LFSR_SEED[i0].LFSR_SEED.load_next) begin
                field_storage.HMAC256_LFSR_SEED[i0].LFSR_SEED.value <= field_combo.HMAC256_LFSR_SEED[i0].LFSR_SEED.next;
            end
        end
        assign hwif_out.HMAC256_LFSR_SEED[i0].LFSR_SEED.value = field_storage.HMAC256_LFSR_SEED[i0].LFSR_SEED.value;
    end
    // Field: hmac256_reg.intr_block_rf.global_intr_en_r.error_en
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.global_intr_en_r.notif_en
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_en_r.error0_en
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_en_r.error1_en
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_en_r.error2_en
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_en_r.error3_en
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.notif_intr_en_r.notif_cmd_done_en
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_global_intr_r.agg_sts
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.notif_global_intr_r.agg_sts
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_internal_intr_r.error0_sts
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_internal_intr_r.error1_sts
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_internal_intr_r.error2_sts
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_internal_intr_r.error3_sts
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.notif_internal_intr_r.notif_cmd_done_sts
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_trig_r.error0_trig
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_trig_r.error1_trig
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_trig_r.error2_trig
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error_intr_trig_r.error3_trig
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.notif_intr_trig_r.notif_cmd_done_trig
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error0_intr_count_r.cnt
    always_comb begin
        automatic logic [31:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error1_intr_count_r.cnt
    always_comb begin
        automatic logic [31:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error2_intr_count_r.cnt
    always_comb begin
        automatic logic [31:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error3_intr_count_r.cnt
    always_comb begin
        automatic logic [31:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.notif_cmd_done_intr_count_r.cnt
    always_comb begin
        automatic logic [31:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error0_intr_count_incr_r.pulse
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error1_intr_count_incr_r.pulse
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error2_intr_count_incr_r.pulse
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.error3_intr_count_incr_r.pulse
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    // Field: hmac256_reg.intr_block_rf.notif_cmd_done_intr_count_incr_r.pulse
    always_comb begin
        automatic logic [0:0] next_c;
        automatic logic load_next_c;
    ...
    for(genvar i0=0; i0<2; i0++) begin
        assign readback_array[i0*1 + 0][31:0] = (decoded_reg_strb.HMAC256_NAME[i0] && !decoded_req_is_wr) ? hwif_in.HMAC256_NAME[i0].NAME.next : '0;
    end
    for(genvar i0=0; i0<2; i0++) begin
        assign readback_array[i0*1 + 2][31:0] = (decoded_reg_strb.HMAC256_VERSION[i0] && !decoded_req_is_wr) ? hwif_in.HMAC256_VERSION[i0].VERSION.next : '0;
    end
    assign readback_array[4][0:0] = (decoded_reg_strb.HMAC256_STATUS && !decoded_req_is_wr) ? hwif_in.HMAC256_STATUS.READY.next : '0;
    assign readback_array[4][1:1] = (decoded_reg_strb.HMAC256_STATUS && !decoded_req_is_wr) ? hwif_in.HMAC256_STATUS.VALID.next : '0;
    assign readback_array[4][31:2] = '0;
    for(genvar i0=0; i0<8; i0++) begin
        assign readback_array[i0*1 + 5][31:0] = (decoded_reg_strb.HMAC256_TAG[i0] && !decoded_req_is_wr) ? field_storage.HMAC256_TAG[i0].TAG.value : '0;
    end
