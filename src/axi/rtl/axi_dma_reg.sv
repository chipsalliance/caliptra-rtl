...
module axi_dma_reg (
    ...
    assign readback_array[2][15:2] = (decoded_reg_strb.ctrl && !decoded_req_is_wr) ? 'h0 : '0;
    ...
    assign readback_array[3][31:20] = (decoded_reg_strb.status0 && !decoded_req_is_wr) ? 'h0 : '0;
