...
#define KV_WR_CTRL_ECC_MSG_DEST_VALID_LOW (SHA512_REG_SHA512_KV_WR_CTRL_ECC_MSG_DEST_VALID_LOW)
#define KV_WR_CTRL_ECC_MSG_DEST_VALID_MASK (SHA512_REG_SHA512_KV_WR_CTRL_ECC_MSG_DEST_VALID_MASK)
