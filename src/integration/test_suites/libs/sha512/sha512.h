...
inline void sha_poll_gen_hash_ready() {
    while((lsu_read_32((uint32_t*) CLP_SHA512_REG_SHA512_GEN_PCR_HASH_STATUS) & SHA512_REG_SHA512_GEN_PCR_HASH_STATUS_READY_MASK) == 0);
}
inline void sha_poll_gen_hash_valid() {
    while((lsu_read_32((uint32_t*) CLP_SHA512_REG_SHA512_GEN_PCR_HASH_STATUS) & SHA512_REG_SHA512_GEN_PCR_HASH_STATUS_VALID_MASK) == 0);
}
