...
// HMAC512 notif must be serviced (not stubbed) because this test runs a real
// HMAC512 operation to create concurrent-engine activity. Leaving the
// interrupt pending would storm the ISR.
