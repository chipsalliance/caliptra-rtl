...
#define VEER_INTR_PRIO_AES_ERROR        8
#define VEER_INTR_PRIO_AES_NOTIF        7
#define VEER_INTR_PRIO_RSVD1_ERROR      4
#define VEER_INTR_PRIO_RSVD1_NOTIF      3
#define VEER_INTR_PRIO_SHA3_ERROR       8
#define VEER_INTR_PRIO_SHA3_NOTIF       7
...
#define VEER_INTR_PRIO_HMAC256_ERROR    8
#define VEER_INTR_PRIO_HMAC256_NOTIF    7
