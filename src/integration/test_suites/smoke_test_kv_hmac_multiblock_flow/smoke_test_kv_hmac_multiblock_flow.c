...
void main() {
    ...
    hmac384_flow(hmac384_key, hmac_block2, hmac_lfsr_seed, hmac384_tag, FALSE, TRUE);
    hmac_zeroize();

    //sign with the generated key
    uint8_t curve_sel = 0;
    uint8_t nondet = 0;
    ecc_signing_flow(privkey, msg, iv, sign_r, sign_s, TRUE, curve_sel, nondet);
