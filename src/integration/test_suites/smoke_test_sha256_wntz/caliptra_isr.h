...
inline void service_sha256_error_intr() {
    ...
    /* Write 1 to Clear the pending interrupt */
    if (sts & SHA256_REG_INTR_BLOCK_RF_ERROR_INTERNAL_INTR_R_ERROR1_STS_MASK) {
        *reg = SHA256_REG_INTR_BLOCK_RF_ERROR_INTERNAL_INTR_R_ERROR1_STS_MASK;
        cptra_intr_rcv.sha256_error |= SHA256_REG_INTR_BLOCK_RF_ERROR_INTERNAL_INTR_R_ERROR1_STS_MASK;
    }
}
