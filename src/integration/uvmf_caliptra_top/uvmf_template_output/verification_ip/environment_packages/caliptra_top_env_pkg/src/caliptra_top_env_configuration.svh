...
//
  ...
  // Interface initialization for sub-environments
    soc_ifc_subenv_interface_names    = new[8];
    soc_ifc_subenv_interface_activity = new[8];

    soc_ifc_subenv_interface_names     = interface_names[0:7];
    soc_ifc_subenv_interface_activity  = interface_activity[0:7];
