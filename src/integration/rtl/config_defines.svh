...
//`define CALIPTRA_INTERNAL_TRNG
  ...
  `define CALIPTRA_AHB_MASTERS_NUM     5'd1 // Number of masters AHB
  ...
  // AHB Address Map
  `define CALIPTRA_SLAVE_NAMES         { "IMEM"      , "ENTROPY_SRC", "CSRNG",       "SHA256"      , "VEER_ICCM_DMA" , "VEER_DCCM_DMA"  , "SOC_IFC"    , "I3C"        , "UART"       , "QSPI"       , "SHA512"     , "DATAVAULT"  , "PCRVAULT"   , "KEYVAULT"   , "HMAC"       , "ECC"        , "DOE_CTRL"   } /* Array of names for peripherals */
  `define CALIPTRA_SLAVE_BASE_ADDR     {32'h0000_0000, 32'h2000_3000, 32'h2000_2000, 32'h1002_8000, 32'h4000_0000   , 32'h5000_0000    , 32'h3000_0000, 32'hFFFF_FFFF, 32'hFFFF_FFFF, 32'hFFFF_FFFF, 32'h1002_0000, 32'h1001_C000, 32'h1001_A000, 32'h1001_8000, 32'h1001_0000, 32'h1000_8000, 32'h1000_0000} /* Array with slave base address */
  `define CALIPTRA_SLAVE_MASK_ADDR     {32'h0000_8000, 32'h2000_0FFF, 32'h2000_0FFF, 32'h1002_FFFF, 32'h4001_FFFF   , 32'h5001_FFFF    , 32'h3003_FFFF, 32'hFFFF_FFFF, 32'hFFFF_FFFF, 32'hFFFF_FFFF, 32'h1002_7FFF, 32'h1001_DFFF, 32'h1001_BFFF, 32'h1001_9FFF, 32'h1001_0FFF, 32'h1000_FFFF, 32'h1000_7FFF} /* Array with slave offset address */
  ...
  `define CALIPTRA_SLAVE_SEL_CSRNG       14
  `define CALIPTRA_SLAVE_SEL_ENTROPY_SRC 15
  `define CALIPTRA_SLAVE_SEL_IMEM      16
