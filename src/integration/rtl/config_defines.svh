...
//`define CALIPTRA_FUSE_GRANULARITY_32
  ...
  `define CALIPTRA_AHB_SLAVES_NUM      5'd20 // Number of slaves AHB
  ...
  // AHB Address Map
  `define CALIPTRA_SLAVE_NAMES         {"HMAC256"    , "ENTROPY_COMBINER", "ENTROPY_SRC1", "SHA3"       , "AES"        , "MLDSA"      , "ENTROPY_SRC", "CSRNG"      , "IMEM"       , "SHA256"     , "VEER_ICCM_DMA", "VEER_DCCM_DMA", "SOC_IFC"    , "SHA512"     , "DATAVAULT"  , "PCRVAULT"   , "KEYVAULT"   , "HMAC"       , "ECC"        , "DOE_CTRL"   } /* Array of names for peripherals */
  `define CALIPTRA_SLAVE_BASE_ADDR     {32'h1004_2000, 32'h2000_5000  , 32'h2000_4000  , 32'h1004_0000, 32'h1001_1000, 32'h1003_0000, 32'h2000_3000, 32'h2000_2000, 32'h0000_0000, 32'h1002_8000, 32'h4000_0000  , 32'h5000_0000  , 32'h3000_0000, 32'h1002_0000, 32'h1001_C000, 32'h1001_A000, 32'h1001_8000, 32'h1001_0000, 32'h1000_8000, 32'h1000_0000} /* Array with slave base address */
  `define CALIPTRA_SLAVE_MASK_ADDR     {32'h1004_2FFF, 32'h2000_5FFF  , 32'h2000_4FFF  , 32'h1004_1FFF, 32'h1001_1FFF, 32'h1003_FFFF, 32'h2000_3FFF, 32'h2000_2FFF, 32'h0001_7FFF, 32'h1002_FFFF, 32'h4003_FFFF  , 32'h5003_FFFF  , 32'h3007_FFFF, 32'h1002_7FFF, 32'h1001_DFFF, 32'h1001_BFFF, 32'h1001_9FFF, 32'h1001_0FFF, 32'h1000_FFFF, 32'h1000_7FFF} /* Array with slave offset address */
  ...
  `define CALIPTRA_SLAVE_SEL_ENTROPY_SRC1 17
  `define CALIPTRA_SLAVE_SEL_COMBINER     18
  `define CALIPTRA_SLAVE_SEL_HMAC256      19
  ...
  `define VEER_INTR_VEC_AES_ERROR     13
  `define VEER_INTR_VEC_AES_NOTIF     14
  ...
  `define VEER_INTR_VEC_HMAC256_ERROR 27
  `define VEER_INTR_VEC_HMAC256_NOTIF 28
  // Used to tie-off unused upper intr bits
  `define VEER_INTR_VEC_MAX_ASSIGNED `VEER_INTR_VEC_HMAC256_NOTIF
