...
#define CLP_MLDSA_REG_MLDSA_PUBKEY                                                                  (0x10031000)
#define MLDSA_REG_MLDSA_PUBKEY                                                                      (0x1000)
#define CLP_MLDSA_REG_MLDSA_SIGNATURE                                                               (0x10032000)
#define MLDSA_REG_MLDSA_SIGNATURE                                                                   (0x2000)
#define CLP_MLDSA_REG_MLDSA_PRIVKEY_OUT                                                             (0x10034000)
#define MLDSA_REG_MLDSA_PRIVKEY_OUT                                                                 (0x4000)
#define CLP_MLDSA_REG_MLDSA_PRIVKEY_IN                                                              (0x10036000)
#define MLDSA_REG_MLDSA_PRIVKEY_IN                                                                  (0x6000)
