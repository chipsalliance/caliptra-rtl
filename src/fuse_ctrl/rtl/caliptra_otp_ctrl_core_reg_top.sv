...
module caliptra_otp_ctrl_core_reg_top (
  input clk_i,
  input rst_ni,
  ...
  // To HW
  output caliptra_otp_ctrl_reg_pkg::caliptra_otp_ctrl_core_reg2hw_t reg2hw, // Write
  input  caliptra_otp_ctrl_reg_pkg::caliptra_otp_ctrl_core_hw2reg_t hw2reg, // Read
  ...
  tlul_rsp_intg_gen #(
    .EnableRspIntgGen(1), // [anjpar]: 09/19/2024 Disable response integrity generation
    .EnableDataIntgGen(1) // [anjpar]: 09/19/2024 Disable data integrity generation
  ) u_rsp_intg_gen (
    .tl_i(tl_o_pre),
    .tl_o(tl_o)
  );
  ...
  logic status_non_secret_fuses_error_qs;
  ...
  logic non_secret_fuses_read_lock_we;
  logic non_secret_fuses_read_lock_qs;
  logic non_secret_fuses_read_lock_wd;
  ...
  logic non_secret_fuses_digest_0_re;
  logic [31:0] non_secret_fuses_digest_0_qs;
  logic non_secret_fuses_digest_1_re;
  logic [31:0] non_secret_fuses_digest_1_qs;
  ...
  //   F[non_secret_fuses_error]: 1:1
  caliptra_prim_subreg_ext #(
    .DW    (1)
  ) u_status_non_secret_fuses_error (
    .re     (status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.status.non_secret_fuses_error.d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (status_non_secret_fuses_error_qs)
  );
  ...
  */
  ...
  // R[non_secret_fuses_read_lock]: V(False)
  // Create REGWEN-gated WE signal
  logic non_secret_fuses_read_lock_gated_we;
  assign non_secret_fuses_read_lock_gated_we =
    non_secret_fuses_read_lock_we & direct_access_regwen_qs;
  caliptra_prim_subreg #(
    .DW      (1),
    .SwAccess(caliptra_prim_subreg_pkg::SwAccessW0C),
    .RESVAL  (1'h1),
    .Mubi    (1'b0)
  ) u_non_secret_fuses_read_lock (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (non_secret_fuses_read_lock_gated_we),
    .wd     (non_secret_fuses_read_lock_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.non_secret_fuses_read_lock.q),
    .ds     (),

    // to register interface (read)
    .qs     (non_secret_fuses_read_lock_qs)
  );
  ...
  // Subregister 0 of Multireg non_secret_fuses_digest
  // R[non_secret_fuses_digest_0]: V(True)
  caliptra_prim_subreg_ext #(
    .DW    (32)
  ) u_non_secret_fuses_digest_0 (
    .re     (non_secret_fuses_digest_0_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.non_secret_fuses_digest[0].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (non_secret_fuses_digest_0_qs)
  );


  // Subregister 1 of Multireg non_secret_fuses_digest
  // R[non_secret_fuses_digest_1]: V(True)
  caliptra_prim_subreg_ext #(
    .DW    (32)
  ) u_non_secret_fuses_digest_1 (
    .re     (non_secret_fuses_digest_1_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.non_secret_fuses_digest[1].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (non_secret_fuses_digest_1_qs)
  );
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[ 0] = (reg_addr == CALIPTRA_OTP_CTRL_INTR_STATE_OFFSET);
    addr_hit[ 1] = (reg_addr == CALIPTRA_OTP_CTRL_INTR_ENABLE_OFFSET);
    addr_hit[ 2] = (reg_addr == CALIPTRA_OTP_CTRL_INTR_TEST_OFFSET);
    addr_hit[ 3] = (reg_addr == CALIPTRA_OTP_CTRL_ALERT_TEST_OFFSET);
    addr_hit[ 4] = (reg_addr == CALIPTRA_OTP_CTRL_STATUS_OFFSET);
    addr_hit[ 5] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_0_OFFSET);
    addr_hit[ 6] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_1_OFFSET);
    addr_hit[ 7] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_2_OFFSET);
    addr_hit[ 8] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_3_OFFSET);
    addr_hit[ 9] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_4_OFFSET);
    addr_hit[10] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_5_OFFSET);
    addr_hit[11] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_6_OFFSET);
    addr_hit[12] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_7_OFFSET);
    addr_hit[13] = (reg_addr == CALIPTRA_OTP_CTRL_ERR_CODE_8_OFFSET);
    addr_hit[14] = (reg_addr == CALIPTRA_OTP_CTRL_DIRECT_ACCESS_REGWEN_OFFSET);
    addr_hit[15] = (reg_addr == CALIPTRA_OTP_CTRL_DIRECT_ACCESS_CMD_OFFSET);
    addr_hit[16] = (reg_addr == CALIPTRA_OTP_CTRL_DIRECT_ACCESS_ADDRESS_OFFSET);
    addr_hit[17] = (reg_addr == CALIPTRA_OTP_CTRL_DIRECT_ACCESS_WDATA_0_OFFSET);
    addr_hit[18] = (reg_addr == CALIPTRA_OTP_CTRL_DIRECT_ACCESS_WDATA_1_OFFSET);
    addr_hit[19] = (reg_addr == CALIPTRA_OTP_CTRL_DIRECT_ACCESS_RDATA_0_OFFSET);
    addr_hit[20] = (reg_addr == CALIPTRA_OTP_CTRL_DIRECT_ACCESS_RDATA_1_OFFSET);
    addr_hit[21] = (reg_addr == CALIPTRA_OTP_CTRL_CHECK_TRIGGER_REGWEN_OFFSET);
    addr_hit[22] = (reg_addr == CALIPTRA_OTP_CTRL_CHECK_TRIGGER_OFFSET);
    addr_hit[23] = (reg_addr == CALIPTRA_OTP_CTRL_CHECK_REGWEN_OFFSET);
    addr_hit[24] = (reg_addr == CALIPTRA_OTP_CTRL_CHECK_TIMEOUT_OFFSET);
    addr_hit[25] = (reg_addr == CALIPTRA_OTP_CTRL_INTEGRITY_CHECK_PERIOD_OFFSET);
    addr_hit[26] = (reg_addr == CALIPTRA_OTP_CTRL_CONSISTENCY_CHECK_PERIOD_OFFSET);
    addr_hit[27] = (reg_addr == CALIPTRA_OTP_CTRL_VENDOR_TEST_READ_LOCK_OFFSET);
    addr_hit[28] = (reg_addr == CALIPTRA_OTP_CTRL_NON_SECRET_FUSES_READ_LOCK_OFFSET);
    addr_hit[29] = (reg_addr == CALIPTRA_OTP_CTRL_VENDOR_TEST_DIGEST_0_OFFSET);
    ...
    addr_hit[32] = (reg_addr == CALIPTRA_OTP_CTRL_NON_SECRET_FUSES_DIGEST_1_OFFSET);
    addr_hit[33] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET0_DIGEST_0_OFFSET);
    addr_hit[34] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET0_DIGEST_1_OFFSET);
    addr_hit[35] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET1_DIGEST_0_OFFSET);
    addr_hit[36] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET1_DIGEST_1_OFFSET);
    addr_hit[37] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET2_DIGEST_0_OFFSET);
    addr_hit[38] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET2_DIGEST_1_OFFSET);
    addr_hit[39] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET3_DIGEST_0_OFFSET);
    addr_hit[40] = (reg_addr == CALIPTRA_OTP_CTRL_SECRET3_DIGEST_1_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[10] & ~reg_be))) |
               (addr_hit[11] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[11] & ~reg_be))) |
               (addr_hit[12] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[12] & ~reg_be))) |
               (addr_hit[13] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[13] & ~reg_be))) |
               (addr_hit[14] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[14] & ~reg_be))) |
               (addr_hit[15] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[15] & ~reg_be))) |
               (addr_hit[16] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[16] & ~reg_be))) |
               (addr_hit[17] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[17] & ~reg_be))) |
               (addr_hit[18] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[18] & ~reg_be))) |
               (addr_hit[19] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[19] & ~reg_be))) |
               (addr_hit[20] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[20] & ~reg_be))) |
               (addr_hit[21] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[21] & ~reg_be))) |
               (addr_hit[22] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[22] & ~reg_be))) |
               (addr_hit[23] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[23] & ~reg_be))) |
               (addr_hit[24] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[24] & ~reg_be))) |
               (addr_hit[25] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[25] & ~reg_be))) |
               (addr_hit[26] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[26] & ~reg_be))) |
               (addr_hit[27] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[27] & ~reg_be))) |
               (addr_hit[28] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[28] & ~reg_be))) |
               (addr_hit[29] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[29] & ~reg_be))) |
               (addr_hit[30] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[30] & ~reg_be))) |
               (addr_hit[31] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[31] & ~reg_be))) |
               (addr_hit[32] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[32] & ~reg_be))) |
               (addr_hit[33] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[33] & ~reg_be))) |
               (addr_hit[34] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[34] & ~reg_be))) |
               (addr_hit[35] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[35] & ~reg_be))) |
               (addr_hit[36] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[36] & ~reg_be))) |
               (addr_hit[37] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[37] & ~reg_be))) |
               (addr_hit[38] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[38] & ~reg_be))) |
               (addr_hit[39] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[39] & ~reg_be))) |
               (addr_hit[40] & (|(CALIPTRA_OTP_CTRL_CORE_PERMIT[40] & ~reg_be)))));
  end
  ...
  assign direct_access_regwen_re = addr_hit[14] & reg_re & !reg_error;
  assign direct_access_regwen_we = addr_hit[14] & reg_we & !reg_error;

  assign direct_access_regwen_wd = reg_wdata[0];
  assign direct_access_cmd_we = addr_hit[15] & reg_we & !reg_error;
  ...
  assign direct_access_address_we = addr_hit[16] & reg_we & !reg_error;

  assign direct_access_address_wd = reg_wdata[11:0];
  assign direct_access_wdata_0_we = addr_hit[17] & reg_we & !reg_error;

  assign direct_access_wdata_0_wd = reg_wdata[31:0];
  assign direct_access_wdata_1_we = addr_hit[18] & reg_we & !reg_error;

  assign direct_access_wdata_1_wd = reg_wdata[31:0];
  assign direct_access_rdata_0_re = addr_hit[19] & reg_re & !reg_error;
  assign direct_access_rdata_1_re = addr_hit[20] & reg_re & !reg_error;
  assign check_trigger_regwen_we = addr_hit[21] & reg_we & !reg_error;

  assign check_trigger_regwen_wd = reg_wdata[0];
  assign check_trigger_we = addr_hit[22] & reg_we & !reg_error;

  assign check_trigger_integrity_wd = reg_wdata[0];

  assign check_trigger_consistency_wd = reg_wdata[1];
  assign check_regwen_we = addr_hit[23] & reg_we & !reg_error;

  assign check_regwen_wd = reg_wdata[0];
  assign check_timeout_we = addr_hit[24] & reg_we & !reg_error;

  assign check_timeout_wd = reg_wdata[31:0];
  assign integrity_check_period_we = addr_hit[25] & reg_we & !reg_error;

  assign integrity_check_period_wd = reg_wdata[31:0];
  assign consistency_check_period_we = addr_hit[26] & reg_we & !reg_error;

  assign consistency_check_period_wd = reg_wdata[31:0];
  assign vendor_test_read_lock_we = addr_hit[27] & reg_we & !reg_error;

  assign vendor_test_read_lock_wd = reg_wdata[0];
  assign non_secret_fuses_read_lock_we = addr_hit[28] & reg_we & !reg_error;

  assign non_secret_fuses_read_lock_wd = reg_wdata[0];
  assign vendor_test_digest_0_re = addr_hit[29] & reg_re & !reg_error;
  assign vendor_test_digest_1_re = addr_hit[30] & reg_re & !reg_error;
  assign non_secret_fuses_digest_0_re = addr_hit[31] & reg_re & !reg_error;
  assign non_secret_fuses_digest_1_re = addr_hit[32] & reg_re & !reg_error;
  assign secret0_digest_0_re = addr_hit[33] & reg_re & !reg_error;
  assign secret0_digest_1_re = addr_hit[34] & reg_re & !reg_error;
  assign secret1_digest_0_re = addr_hit[35] & reg_re & !reg_error;
  assign secret1_digest_1_re = addr_hit[36] & reg_re & !reg_error;
  assign secret2_digest_0_re = addr_hit[37] & reg_re & !reg_error;
  assign secret2_digest_1_re = addr_hit[38] & reg_re & !reg_error;
  assign secret3_digest_0_re = addr_hit[39] & reg_re & !reg_error;
  assign secret3_digest_1_re = addr_hit[40] & reg_re & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[14] = direct_access_regwen_we;
    reg_we_check[15] = direct_access_cmd_gated_we;
    reg_we_check[16] = direct_access_address_gated_we;
    reg_we_check[17] = direct_access_wdata_0_gated_we;
    reg_we_check[18] = direct_access_wdata_1_gated_we;
    reg_we_check[19] = 1'b0;
    reg_we_check[20] = 1'b0;
    reg_we_check[21] = check_trigger_regwen_we;
    reg_we_check[22] = check_trigger_gated_we;
    reg_we_check[23] = check_regwen_we;
    reg_we_check[24] = check_timeout_gated_we;
    reg_we_check[25] = integrity_check_period_gated_we;
    reg_we_check[26] = consistency_check_period_gated_we;
    reg_we_check[27] = vendor_test_read_lock_gated_we;
    reg_we_check[28] = non_secret_fuses_read_lock_gated_we;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[4]: begin
        ...
        reg_rdata_next[1] = status_non_secret_fuses_error_qs;
        reg_rdata_next[2] = status_secret0_error_qs;
        reg_rdata_next[3] = status_secret1_error_qs;
        reg_rdata_next[4] = status_secret2_error_qs;
        reg_rdata_next[5] = status_secret3_error_qs;
        ...
        reg_rdata_next[12] = status_bus_integ_error_qs;
      ...
      addr_hit[28]: begin
        reg_rdata_next[0] = non_secret_fuses_read_lock_qs;
      end
      ...
      addr_hit[31]: begin
        reg_rdata_next[31:0] = non_secret_fuses_digest_0_qs;
      end

      addr_hit[32]: begin
        reg_rdata_next[31:0] = non_secret_fuses_digest_1_qs;
      end
