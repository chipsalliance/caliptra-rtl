...
module caliptra_otp_ctrl_prim_reg_top (
  input clk_i,
  input rst_ni,
  input  tlul_pkg::tl_h2d_t tl_i,
  output tlul_pkg::tl_d2h_t tl_o,
  // To HW
  output caliptra_otp_ctrl_reg_pkg::caliptra_otp_ctrl_prim_reg2hw_t reg2hw, // Write
  input  caliptra_otp_ctrl_reg_pkg::caliptra_otp_ctrl_prim_hw2reg_t hw2reg, // Read
  ...
  tlul_rsp_intg_gen #(
    ...
    .EnableDataIntgGen(1) // [anjpar]: 09/19/2024: Disable response integrity generation
  ) u_rsp_intg_gen (
    .tl_i(tl_o_pre),
    .tl_o(tl_o)
  );
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[0] = (reg_addr == CALIPTRA_OTP_CTRL_CSR0_OFFSET);
    addr_hit[1] = (reg_addr == CALIPTRA_OTP_CTRL_CSR1_OFFSET);
    ...
    addr_hit[5] = (reg_addr == CALIPTRA_OTP_CTRL_CSR5_OFFSET);
    addr_hit[6] = (reg_addr == CALIPTRA_OTP_CTRL_CSR6_OFFSET);
    addr_hit[7] = (reg_addr == CALIPTRA_OTP_CTRL_CSR7_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[0] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[0] & ~reg_be))) |
               (addr_hit[1] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[1] & ~reg_be))) |
               (addr_hit[2] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[2] & ~reg_be))) |
               (addr_hit[3] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[3] & ~reg_be))) |
               (addr_hit[4] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[4] & ~reg_be))) |
               (addr_hit[5] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[5] & ~reg_be))) |
               (addr_hit[6] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[6] & ~reg_be))) |
               (addr_hit[7] & (|(CALIPTRA_OTP_CTRL_PRIM_PERMIT[7] & ~reg_be)))));
  end
