#!/usr/bin/env bash
# Generate the HMAC UVMF environment from the yaml files in this directory.
#
...
# - The DPI-C block in HMAC_environment.yaml triggers generation of
#   the dpi header + Makefile rules; the hand-written hmac_dpi.c is
#   dropped into uvmf_template_output/.../HMAC_env_pkg/dpi/ after the
#   first generate.
