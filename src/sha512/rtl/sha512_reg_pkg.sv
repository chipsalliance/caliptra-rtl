...
package sha512_reg_pkg;
    ...
    typedef struct {
        ...
        sha512_reg__SHA512_BLOCK__in_t SHA512_BLOCK[32];
        ...
        sha512_reg__SHA512_GEN_PCR_HASH_DIGEST__in_t SHA512_GEN_PCR_HASH_DIGEST[12];
    ...
    typedef struct {
        ...
        sha512_reg__SHA512_GEN_PCR_HASH_NONCE__out_t SHA512_GEN_PCR_HASH_NONCE[8];
