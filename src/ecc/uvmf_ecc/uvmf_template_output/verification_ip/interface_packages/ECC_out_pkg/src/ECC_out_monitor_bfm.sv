    ...
    if (rst_n_i == 0) begin
      ...
      if (transaction_flag_out_monitor_i == 1 ) begin
        ...
        if (op == 2'b00) begin // KEY_GEN
          ...
          @(posedge clk_i);
          privkey[383:352] = hrdata_32_i;
          //$display("**ECC_out_monitor_bfm: privkey[383:352] = %h, time = %0t", privkey[383:352], $time);
          repeat (2) @(posedge clk_i);
          privkey[351:320] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[319:288] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[287:256] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[255:224] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[223:192] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[191:160] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[159:128] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[127:96]  = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[95:64]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[63:32]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          privkey[31:0]    = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[383:352] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[351:320] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[319:288] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[287:256] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[255:224] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[223:192] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[191:160] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[159:128] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[127:96]  = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[95:64]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[63:32]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_x[31:0]    = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[383:352] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[351:320] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[319:288] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[287:256] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[255:224] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[223:192] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[191:160] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[159:128] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[127:96]  = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[95:64]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[63:32]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          pubkey_y[31:0]    = hrdata_32_i;
          ...
          @(posedge clk_i);
          R[383:352] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[351:320] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[319:288] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[287:256] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[255:224] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[223:192] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[191:160] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[159:128] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[127:96]  = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[95:64]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          R[63:32]   = hrdata_32_i;
          ...
          R[31:0]    = hrdata_32_i;
          repeat (2) @(posedge clk_i);       
          S[383:352] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[351:320] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[319:288] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[287:256] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[255:224] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[223:192] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[191:160] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[159:128] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[127:96]  = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[95:64]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          S[63:32]   = hrdata_32_i;
          ...
          @(posedge clk_i);
          verify_R[383:352] = hrdata_32_i;      
          repeat (2) @(posedge clk_i);
          verify_R[351:320] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[319:288] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[287:256] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[255:224] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[223:192] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[191:160] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[159:128] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[127:96]  = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[95:64]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[63:32]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          verify_R[31:0]    = hrdata_32_i;
          ...
          @(posedge clk_i);
          dh_sharedkey[383:352] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[351:320] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[319:288] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[287:256] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[255:224] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[223:192] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[191:160] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[159:128] = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[127:96]  = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[95:64]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[63:32]   = hrdata_32_i;
          repeat (2) @(posedge clk_i);
          dh_sharedkey[31:0]    = hrdata_32_i;
