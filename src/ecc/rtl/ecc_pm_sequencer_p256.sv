...
// INV/INVq are emitted at their natural P-256 length (704 entries each,
// last is ST_MUL_*_INV_OUT at offset +703); ecc_pm_ctrl uses the
// INV_E_P256 / INVq_E_P256 anchors to short-circuit the FSM and skip
// what would otherwise be ~336 NOP cycles per inversion.
// Any ROM address beyond the emitted range falls through the case-
// default to UOP_NOP and is never reached on P-256 (curve_sel_i=1).
