...
module ecc_reg (
    ...
    always_comb begin
        ...
        load_next_c = '0;
        if(decoded_reg_strb.ecc_kv_wr_pkey_ctrl && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.ecc_kv_wr_pkey_ctrl.rsvd.value & ~decoded_wr_biten[31:14]) | (decoded_wr_data[31:14] & decoded_wr_biten[31:14]);
            load_next_c = '1;
        end
    ...
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.ecc_kv_wr_pkey_ctrl.rsvd.value <= 18'h0;
    ...
    assign readback_array[93][31:14] = (decoded_reg_strb.ecc_kv_wr_pkey_ctrl && !decoded_req_is_wr) ? field_storage.ecc_kv_wr_pkey_ctrl.rsvd.value : '0;
