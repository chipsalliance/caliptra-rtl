...
package ecc_reg_pkg;
    ...
    typedef struct {
        ...
        ecc_reg__ECC_MSG__in_t ECC_MSG[12];
        ecc_reg__ECC_PRIVKEY_OUT__in_t ECC_PRIVKEY_OUT[12];
        ...
        ecc_reg__ECC_IV__in_t ECC_IV[12];
        ecc_reg__ECC_NONCE__in_t ECC_NONCE[12];
        ecc_reg__ECC_PRIVKEY_IN__in_t ECC_PRIVKEY_IN[12];
    ...
    typedef struct {
        ...
        ecc_reg__ECC_NONCE__out_t ECC_NONCE[12];
        ecc_reg__ECC_PRIVKEY_IN__out_t ECC_PRIVKEY_IN[12];
