...
#(
  ...
  parameter [REG_SIZE-1 : 0] PRIME_P256       = { {(REG_SIZE-256){1'b0}}, 256'hFFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551 },
  parameter [REG_SIZE-1 : 0] HMAC_DRBG_PRIME  = PRIME_P256
)
(
  // Clock and reset.
  input  wire                       clk,
