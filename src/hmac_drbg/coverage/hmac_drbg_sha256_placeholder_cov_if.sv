...
interface hmac_drbg_sha256_placeholder_cov_if
    ...
    covergroup hmac_drbg_sha256_state_cg @(posedge clk);
        drbg_state_cp: coverpoint drbg_state {
            bins all_states[] = {[0:14]};
        }
    endgroup

    hmac_drbg_sha256_state_cg hmac_drbg_sha256_state_cov = new();
    hmac_drbg_sha256_control_cg hmac_drbg_sha256_control_cov = new();
