...
python3 tools/scripts/reg_gen.py $CALIPTRA_ROOT/src/entropy_combiner/rtl/entropy_combiner_reg.rdl
...
python3 tools/scripts/reg_gen.py $CALIPTRA_ROOT/src/hmac256/rtl/hmac256_reg.rdl
